...
TOKEN = "8133767092:AAGXXhLvad9X9PvJb1vMUhxvXWGOUMvGNoY"
ADMIN_IDS = "6353114118"
GROUP_ID = "-1002327785449"
FEEDBACK_CHANNEL_ID = "-1002364415379"
JOIN_CHANNEL_ID = "@ISAGIxCRACKS"
EXEMPTED_USERS = ["6353114118"]
...
def welcome_start(message):
    ...
    welcome_text = (
        ...
        "[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/ISAGIxDDOS)\n\n"
        "📌 *𝗧𝗿𝘆 𝗧𝗵𝗶𝘀 𝗖𝗼𝗺𝗺𝗮𝗻𝗱:*\n"
        "`/bgmi` - 🚀 *Start an attack!*\n\n"
        "👑 *𝗕𝗢𝗧 𝗖𝗥𝗘𝗔𝗧𝗘𝗗 𝗕𝗬:* [@SLAYER_OP7](https://t.me/SLAYER_OP7) 💀"
    )

    # Inline buttons
    keyboard = InlineKeyboardMarkup()
    keyboard.add(
        InlineKeyboardButton("➖ 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ➖", url="https://t.me/ISAGIxDDOS")
    )
    keyboard.add(
        InlineKeyboardButton("👑 𝗖𝗥𝗘𝗔𝗧𝗢𝗥 👑", url="https://t.me/SLAYER_OP7")
    )
...
def help_command(message):
    help_text = (
        ...
        "📢 [Join Channel](https://t.me/ISAGIxCRACKS)\n"
        "👑 [Bot Creator](https://t.me/SLAYER_OP7)"
    )
...
def bgmi_command(message):
    ...
    try:
        ...
        if user_status not in ["member", "administrator", "creator"]:
            ...
            keyboard = InlineKeyboardMarkup()
            join_button = InlineKeyboardButton("➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖", url="https://t.me/ISAGIxDDOS")
                ...
                if photos.total_count > 0:
                    ...
                    bot.send_photo(
                        ...
                        caption=(
                            ...
                            f" [➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/ISAGIxDDOS)\n\n"
    ...
    if str(message.chat.id) != GROUP_ID:
        bot.send_message(
            ...
            "🔗 𝙅𝙤𝙞𝙣 𝙏𝙝𝙚 𝙃𝙊𝙈𝙀 𝙊𝙁 𝙋𝙊𝙒𝙀𝙍: [ISAGIxDDOS](https://t.me/ISAGIxDDOS)\n\n"
            "👑 𝘽𝙊𝙏 𝘾𝙍𝙀𝘼𝙏𝙊𝙍: @SLAYER_OP7 (𝙏𝙐𝙈𝙃𝘼𝙍𝙀_𝙋𝘼𝙋𝘼) 👑"
        )
        return
...
async def run_attack_command_async(target_ip, target_port, user_duration, default_duration, chat_id, username):
    ...
    reply_markup=InlineKeyboardMarkup([
        [
            InlineKeyboardButton("💬 SUPPORT", url="https://t.me/ISAGIxDDOS"),
...
def show_all_commands(message):
    ...
    # Footer with links
    commands_text += (
        "📢 [**Join Channel**](https://t.me/ISAGIxDDOS)\n"
        "👑 [**Creator**](https://t.me/SLAYER_OP7)"
    )
...
# ⚙️『 ISAGI CHANNEL MANAGEMENT PANEL 』⚙️
